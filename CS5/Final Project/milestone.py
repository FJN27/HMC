...
class Board:
    ...
    def aiMove(self, ox):
        ...
        if self.width == 3 and self.height == 3:
            ...
            print('block_N block_N block_N block_N block_N block_N block_N block_N block_N block_N')
            return random.choice(list_block)
             
        elif self.emptyBoard() == True:    # take the central position 
            # NOTE: need to consider odd and even number 

            print('empty_central empty_central empty_central empty_central empty_central empty_central')
            ...
            for row in range(self.height):
                for col in range(self.width):
                    ...
                    if inarow_Neast(ox, row, col, self.data, self.win-2):
                        print('hoizontal_east hoizontal_east hoizontal_east hoizontal_east')
                        # | |x|x|x| --->|O|x|x|x| |
                        if self.allowsMove(col - 1, row) and self.allowsMove(col + self.win - 2, row):
                            ...
                            return [col - 1, row]
                        # |x|x|x| |X| ---> |x|x|x|O|X|
                        elif self.allowsMove(col + self.win - 2, row) and self.data[row][col + self.win - 1] == ox:
                            return [col + self.win - 2, row]
                        
                    # elif inarow_Nsouth(ox, row, col, self.data, self.win-2):
                    elif inarow_Nsouth(ox, row, col, self.data, self.win-2):
                        print('vertical_south vertical_south vertical_south vertical_south')
                        print('*************************')
                        print(row, col)
                        print('*************************')
                    ...
                    # elif inarow_Nnortheast(ox, row, col, self.data, self.win-2):
                        ...
                        print("diagonal_inarow_Nsouth diagonal_inarow_Nsouth diagonal_inarow_Nsouth diagonal_inarow_Nsouth")
                        print('*************************')
                        print(row, col)
                        print('*************************')
                    ...
                    # elif inarow_Nsoutheast(ox, row, col, self.data, self.win-2):
                        ...
                        print('diagonal_inarow_Nsoutheast diagonal_inarow_Nsoutheast diagonal_inarow_Nsoutheast diagonal_inarow_Nsoutheast')
                        print('*************************')
                        print(row, col)
                        print('*************************')
                        ...
                        if self.allowsMove(col - 1, row - 1) and self.allowsMove(col + self.win - 2, row + self.win - 2):
                           return [col - 1, row - 1]
            print('random_choice random_choice random_choice random_choice random_choice')
            return random.choice(allow_move_list)
