...
ball2 = sphere(size = 1.0*vec(1, 1, 1),  # Ball is an object of class sphere
              color = vec(0.8, 0.8, 0.0),
              pos = vec(0.5,0,0)
              )
              
ball2.vel = vec(4, 0, 0)        # This is its initial velocity
